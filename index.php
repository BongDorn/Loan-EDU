...
<!-- Main content -->
<?php include 'includes/saidbar.php';?>
...
<!--                        
                         ...
                         <tr>
                            ...
                            <td class="text-center">
                                 <!-- echo number_format($row['penalty_amount'],2) ?> -->
                            </td>
                            <td class="text-center">
                                    <button class="btn btn-primary edit_payment" type="button" data-id="
                                    
                                    "><i class="fa fa-edit"></i></button>
                                    <button class="btn btn-danger delete_payment" type="button" data-id=""><i class="fa fa-trash"></i></button>
                            </td>
